function addBaseUrl(baseURL, sidebarItems) {
  for (let item of sidebarItems) {
    ...
    if (item.items) {
      addBaseUrl(baseURL, item.items);
    }
  }
}

//遍历sidebar 所有link添加baseurl
...
let BaseUrl = "http://flydoc.dwsy.link";
